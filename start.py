...
async def on_ready():
	...
	while True:
		...
		await bot.change_presence(status = discord.Status.dnd, activity = discord.Activity(type = discord.ActivityType.watching, name="за сервером Winter | Узнать комманды: #help"))
		await asyncio.sleep(5)
